...
import { de_UpdatePlantMaterialCommand, se_UpdatePlantMaterialCommand, } from "../protocols/Aws_restJson1";
import { getSerdePlugin } from "@smithy/middleware-serde";
import { Command as $Command } from "@smithy/smithy-client";
import { SMITHY_CONTEXT_KEY, } from "@smithy/types";
export { $Command };
export class UpdatePlantMaterialCommand extends $Command {
    constructor(input) {
        super();
        this.input = input;
    }
