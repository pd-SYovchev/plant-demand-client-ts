...
import { de_UpdateOrderDateFieldCommand, se_UpdateOrderDateFieldCommand, } from "../protocols/Aws_restJson1";
import { getSerdePlugin } from "@smithy/middleware-serde";
import { Command as $Command } from "@smithy/smithy-client";
import { SMITHY_CONTEXT_KEY, } from "@smithy/types";
export { $Command };
export class UpdateOrderDateFieldCommand extends $Command {
    constructor(input) {
        super();
        this.input = input;
    }
