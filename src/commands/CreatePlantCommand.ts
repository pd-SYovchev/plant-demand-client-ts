 ...
 * ```javascript
 * import { PlantDemandServiceClient, CreatePlantCommand } from "@pd-api/client"; // ES Modules import
 * // const { PlantDemandServiceClient, CreatePlantCommand } = require("@pd-api/client"); // CommonJS import
