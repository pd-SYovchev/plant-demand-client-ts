...
import {
  CreateOrderDateFieldInput,
  OrderField,
} from "../models/models_0";
import {
  de_CreateOrderDateFieldCommand,
  se_CreateOrderDateFieldCommand,
 ...
 * ```javascript
 * import { PlantDemandServiceClient, CreateOrderDateFieldCommand } from "@pd-api/client"; // ES Modules import
 * // const { PlantDemandServiceClient, CreateOrderDateFieldCommand } = require("@pd-api/client"); // CommonJS import
 ...
 *
 */
export class CreateOrderDateFieldCommand extends $Command<CreateOrderDateFieldCommandInput, CreateOrderDateFieldCommandOutput, PlantDemandServiceClientResolvedConfig> {
   ...
   * @public
   */
  constructor(readonly input: CreateOrderDateFieldCommandInput) {
  ...
  resolveMiddleware(
    ...
    const commandName = "CreateOrderDateFieldCommand";
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      [SMITHY_CONTEXT_KEY]: {
        ...
        operation: "CreateOrderDateField",
      },
    }
  ...
  private serialize(
    ...
    return se_CreateOrderDateFieldCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_CreateOrderDateFieldCommand(output, context);
  }
