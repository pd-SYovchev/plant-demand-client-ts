...
import {
  de_DeleteNoteCommand,
  se_DeleteNoteCommand,
 ...
 * ```javascript
 * import { PlantDemandServiceClient, DeleteNoteCommand } from "pd-ts-client"; // ES Modules import
 * // const { PlantDemandServiceClient, DeleteNoteCommand } = require("pd-ts-client"); // CommonJS import
 ...
 *
 */
export class DeleteNoteCommand extends $Command<DeleteNoteCommandInput, DeleteNoteCommandOutput, PlantDemandServiceClientResolvedConfig> {
   ...
   * @public
   */
  constructor(readonly input: DeleteNoteCommandInput) {
  ...
  resolveMiddleware(
    ...
    const commandName = "DeleteNoteCommand";
  ...
  private serialize(
    ...
    return se_DeleteNoteCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_DeleteNoteCommand(output, context);
  }
