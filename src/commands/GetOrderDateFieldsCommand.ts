 ...
 * ```javascript
 * import { PlantDemandServiceClient, GetOrderDateFieldsCommand } from "@pd-api/client"; // ES Modules import
 * // const { PlantDemandServiceClient, GetOrderDateFieldsCommand } = require("@pd-api/client"); // CommonJS import
