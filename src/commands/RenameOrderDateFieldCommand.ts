...
import {
  OrderField,
  RenameOrderDateFieldInput,
} from "../models/models_0";
import {
  de_RenameOrderDateFieldCommand,
  se_RenameOrderDateFieldCommand,
 ...
 * ```javascript
 * import { PlantDemandServiceClient, RenameOrderDateFieldCommand } from "@pd-api/client"; // ES Modules import
 * // const { PlantDemandServiceClient, RenameOrderDateFieldCommand } = require("@pd-api/client"); // CommonJS import
 ...
 *
 */
export class RenameOrderDateFieldCommand extends $Command<RenameOrderDateFieldCommandInput, RenameOrderDateFieldCommandOutput, PlantDemandServiceClientResolvedConfig> {
   ...
   * @public
   */
  constructor(readonly input: RenameOrderDateFieldCommandInput) {
  ...
  ): Handler<RenameOrderDateFieldCommandInput, RenameOrderDateFieldCommandOutput> {
  ...
  private serialize(
    ...
    return se_RenameOrderDateFieldCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return de_RenameOrderDateFieldCommand(output, context);
  }
