...
exports.GetMixDesignByIdCommand = exports.$Command = void 0;
...
class GetMixDesignByIdCommand extends smithy_client_1.Command {
    constructor(input) {
        super();
        this.input = input;
    }
    ...
    serialize(input, context) {
        return (0, Aws_restJson1_1.se_GetMixDesignByIdCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_restJson1_1.de_GetMixDesignByIdCommand)(output, context);
    }
}
exports.GetMixDesignByIdCommand = GetMixDesignByIdCommand;
