...
exports.UpdateOrderFieldCommand = exports.$Command = void 0;
...
class UpdateOrderFieldCommand extends smithy_client_1.Command {
    constructor(input) {
        super();
        this.input = input;
    }
    ...
    serialize(input, context) {
        return (0, Aws_restJson1_1.se_UpdateOrderFieldCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_restJson1_1.de_UpdateOrderFieldCommand)(output, context);
    }
}
exports.UpdateOrderFieldCommand = UpdateOrderFieldCommand;
