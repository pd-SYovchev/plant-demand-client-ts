...
exports.DeleteMixDesignCommand = exports.$Command = void 0;
...
class DeleteMixDesignCommand extends smithy_client_1.Command {
    constructor(input) {
        super();
        this.input = input;
    }
    ...
    serialize(input, context) {
        return (0, Aws_restJson1_1.se_DeleteMixDesignCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_restJson1_1.de_DeleteMixDesignCommand)(output, context);
    }
}
exports.DeleteMixDesignCommand = DeleteMixDesignCommand;
