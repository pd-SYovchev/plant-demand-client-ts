...
exports.GetOrderFieldsCommand = exports.$Command = void 0;
...
class GetOrderFieldsCommand extends smithy_client_1.Command {
    constructor(input) {
        super();
        this.input = input;
    }
    ...
    serialize(input, context) {
        return (0, Aws_restJson1_1.se_GetOrderFieldsCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_restJson1_1.de_GetOrderFieldsCommand)(output, context);
    }
}
exports.GetOrderFieldsCommand = GetOrderFieldsCommand;
