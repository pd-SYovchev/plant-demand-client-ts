...
exports.GetPlantByIdCommand = exports.$Command = void 0;
...
class GetPlantByIdCommand extends smithy_client_1.Command {
    constructor(input) {
        super();
        this.input = input;
    }
    ...
    serialize(input, context) {
        return (0, Aws_restJson1_1.se_GetPlantByIdCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_restJson1_1.de_GetPlantByIdCommand)(output, context);
    }
}
exports.GetPlantByIdCommand = GetPlantByIdCommand;
