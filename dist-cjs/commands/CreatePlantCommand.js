...
exports.CreatePlantCommand = exports.$Command = void 0;
...
class CreatePlantCommand extends smithy_client_1.Command {
    constructor(input) {
        super();
        this.input = input;
    }
    ...
    serialize(input, context) {
        return (0, Aws_restJson1_1.se_CreatePlantCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_restJson1_1.de_CreatePlantCommand)(output, context);
    }
}
exports.CreatePlantCommand = CreatePlantCommand;
