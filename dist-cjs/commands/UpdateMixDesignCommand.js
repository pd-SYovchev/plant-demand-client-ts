...
exports.UpdateMixDesignCommand = exports.$Command = void 0;
...
class UpdateMixDesignCommand extends smithy_client_1.Command {
    constructor(input) {
        super();
        this.input = input;
    }
    ...
    serialize(input, context) {
        return (0, Aws_restJson1_1.se_UpdateMixDesignCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_restJson1_1.de_UpdateMixDesignCommand)(output, context);
    }
}
exports.UpdateMixDesignCommand = UpdateMixDesignCommand;
