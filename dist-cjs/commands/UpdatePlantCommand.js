...
exports.UpdatePlantCommand = exports.$Command = void 0;
...
class UpdatePlantCommand extends smithy_client_1.Command {
    constructor(input) {
        super();
        this.input = input;
    }
    ...
    serialize(input, context) {
        return (0, Aws_restJson1_1.se_UpdatePlantCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_restJson1_1.de_UpdatePlantCommand)(output, context);
    }
}
exports.UpdatePlantCommand = UpdatePlantCommand;
