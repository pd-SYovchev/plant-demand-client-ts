...
exports.GetBusinessesCommand = exports.$Command = void 0;
...
class GetBusinessesCommand extends smithy_client_1.Command {
    constructor(input) {
        super();
        this.input = input;
    }
    ...
    serialize(input, context) {
        return (0, Aws_restJson1_1.se_GetBusinessesCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_restJson1_1.de_GetBusinessesCommand)(output, context);
    }
}
exports.GetBusinessesCommand = GetBusinessesCommand;
