...
import { CreateOrderInput, Order } from "../models/models_0";
 ...
 */
export interface CreateOrderCommandOutput extends Order, __MetadataBearer {
}
/**
 * @public
 *
 ...
 * ```javascript
 * import { PlantDemandServiceClient, CreateOrderCommand } from "@pd-api/client"; // ES Modules import
 * // const { PlantDemandServiceClient, CreateOrderCommand } = require("@pd-api/client"); // CommonJS import
 ...
 *
 */
export declare class CreateOrderCommand extends $Command<CreateOrderCommandInput, CreateOrderCommandOutput, PlantDemandServiceClientResolvedConfig> {
     ...
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: PlantDemandServiceClientResolvedConfig, options?: __HttpHandlerOptions): Handler<CreateOrderCommandInput, CreateOrderCommandOutput>;
    /**
     * @internal
     */
    private serialize;
