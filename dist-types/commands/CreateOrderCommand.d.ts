 ...
 * ```javascript
 * import { PlantDemandServiceClient, CreateOrderCommand } from "pd-ts-client"; // ES Modules import
 * // const { PlantDemandServiceClient, CreateOrderCommand } = require("pd-ts-client"); // CommonJS import
