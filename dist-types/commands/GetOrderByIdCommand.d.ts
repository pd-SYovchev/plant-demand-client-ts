 ...
 * ```javascript
 * import { PlantDemandServiceClient, GetOrderByIdCommand } from "@pd-api/client"; // ES Modules import
 * // const { PlantDemandServiceClient, GetOrderByIdCommand } = require("@pd-api/client"); // CommonJS import
