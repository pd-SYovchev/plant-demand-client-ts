 ...
 * ```javascript
 * import { PlantDemandServiceClient, CreateOrderFieldCommand } from "@pd-api/client"; // ES Modules import
 * // const { PlantDemandServiceClient, CreateOrderFieldCommand } = require("@pd-api/client"); // CommonJS import
