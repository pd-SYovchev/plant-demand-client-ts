 ...
 * ```javascript
 * import { PlantDemandServiceClient, DeletePlantCustomerCommand } from "pd-ts-client"; // ES Modules import
 * // const { PlantDemandServiceClient, DeletePlantCustomerCommand } = require("pd-ts-client"); // CommonJS import
