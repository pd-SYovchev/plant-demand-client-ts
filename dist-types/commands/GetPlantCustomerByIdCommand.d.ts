 ...
 * ```javascript
 * import { PlantDemandServiceClient, GetPlantCustomerByIdCommand } from "@pd-api/client"; // ES Modules import
 * // const { PlantDemandServiceClient, GetPlantCustomerByIdCommand } = require("@pd-api/client"); // CommonJS import
