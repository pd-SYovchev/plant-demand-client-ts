 ...
 * ```javascript
 * import { PlantDemandServiceClient, DeleteOrderCommand } from "@pd-api/client"; // ES Modules import
 * // const { PlantDemandServiceClient, DeleteOrderCommand } = require("@pd-api/client"); // CommonJS import
